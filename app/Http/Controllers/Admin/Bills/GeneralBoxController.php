...
class GeneralBoxController extends Controller
{
    public function show_general_box(Request $request)
    {
        ...
        $bills =DB::select("
                            ...
                            from 
                            (
                            select ad.id, ad.name,  date(deposit_date) as deposited_date, 
