...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">        
        <a href="{{ url('driver/box/show/take/'.$driver->id) }}" class="btn {{$type === 'take'? 'btn-primary': ''}} rounded-0 m-0" >قـبـض</a>
        <a href="{{ url('driver/box/show/spend/'.$driver->id) }}" class="btn {{$type === 'spend'? 'btn-primary': ''}} rounded-0 m-0" >صــرف</a>
