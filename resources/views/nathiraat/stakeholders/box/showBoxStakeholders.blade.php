...
<div class="container clearfix">
    ...
    <div class="float-end mt-3">        
        <a href="{{ url('nathiraat/stakeholders/box/show/take/'.$stakeholder->id) }}" class="btn {{$type === 'take'? 'btn-primary': ''}} rounded-0 m-0" >قـبـض</a>
        <a href="{{ url('nathiraat/stakeholders/box/show/spend/'.$stakeholder->id) }}" class="btn {{$type === 'spend'? 'btn-primary': ''}} rounded-0 m-0" >صــرف</a>
        <a href="{{url('nathiraat/stakeholders/box/add/'.$stakeholder->id)}}" class="btn btn-success rounded-0 m-0" >أضـافـة سند</a>
    </div>
</div>
