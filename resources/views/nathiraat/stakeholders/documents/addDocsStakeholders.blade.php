...
<h5 class="mt-4">أضافة مستند للجهة</h5>

<form  method="POST" action="{{ url('nathiraat/stakeholders/documents/add/'. $id) }}"  enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="nathriaat_id" value="{{ $id }}" require>
    <div class="row">
