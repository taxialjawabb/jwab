...
<div class="container-fluid mt-1 element-center" id="printable">
    ...
    <p  class="mb-3 pt-1 text-center "  style="color: black; font-size: 20px;">فاتورة رقم * {{$bill->bond_number}} *  </p>
    <table class="table table-bordered element-center" >
    <thead>
      <tr>
        <th >
        <p class="m-1"  style="color: black; font-size: 20px;">رقم لوحة المركبة</p>
        </th>
        <th colspan="3">
    ...
    <tbody>
        ...
        <tr>
            <td >
                <p class="m-1"  style="color: black; font-size: 20px;">الوصف</p>
            </td>
            <td  colspan="3" style="color: black; font-size: 20px;">
                {{$bill->descrpition}}
            </td>
      ...
      <tr>
        ...
        <td  style="color: black; font-size: 20px;"> {{$bill->tax}} %</td>
      </tr>
      <tr>
        <td>
